...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_60_ansi_tsangan_split_bs_rshift(
        ...
        KC_LCTL, KC_LALT, KC_LGUI,                            LT(2, KC_SPC),                               GUI_T(KC_LEFT), ALT_T(KC_DOWN), CTL_T(KC_RGHT)
    ),
    ...
    [2] = LAYOUT_60_ansi_tsangan_split_bs_rshift(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, G(KC_Z), G(KC_V), G(KC_C), G(KC_X), S(G(KC_Z)), KC_TRNS, KC_TRNS, KC_TRNS,
